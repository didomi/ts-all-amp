...
window.onload = function() {
  ...
  makeConfigObject();
  makeIframe(document.getElementById('didomiConfig').value, document.querySelector('[data-acb]').value);
  ...
  document.getElementById("check").addEventListener("click", function() {
    var html64 = btoa(document.querySelector('#iframe_container iframe').getAttribute('srcdoc'));
